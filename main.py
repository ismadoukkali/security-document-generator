...
Descripción general del producto: Incluye en negrita la marca y el nombre completo del producto. Proporciona una breve descripción del producto, resaltando su función principal y cualquier uso previsto o contexto en el cual suele emplearse. Incluye también el nombre completo del producto y la marca en un apartado en negrita resaltandolo.
Materiales de fabricación: Detalla los materiales específicos empleados en la fabricación, como tipos de plástico, metal, u otros componentes al igual que los ingredientes del producto si aplica, considerando aspectos de seguridad y durabilidad.
Instrucciones de uso: Explica de forma clara cómo utilizar o instalar el producto, incluyendo cualquier precaución necesaria para evitar daños tanto al producto como al usuario, haz incapié en como realizarlo de la manera más segura posible.
...
Medidas de seguridad: Advierte sobre posibles riesgos asociados con el uso del producto (como riesgos eléctricos, mecánicos, ambientales o de salud) y cómo reducir estos riesgos en la mayor medida posible.
...
Por favor, responde únicamente con el texto en formato 'Markdown', sin utilizar ``` para el formato del código. No incluyas ninugun bulletpoint indentado, solo bulletpoints simples.
'''
